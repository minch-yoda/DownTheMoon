	...
	test("http digests priority", function() {
		...
		const chan = createTestHttpChannel({
			...
			response: {
				...
				"Digest": "SHA-1=" + btoa("01586b2c0ec5d8e985138204404878f5ecbeef58") +
					",SHA-256=" +
					btoa("2413fb3709b05939f04cf2e92f7d0897fc2596f9ad0b8a9ea855c7bfebaae892") +
					",SHA-384=" +
					btoa("38b060a751ac96384cd9327eb1b1e36a21fdb71114be07434c0cc7bf63f6e1da" +
							 "274edebfe76f65fbd51ad2f14898b95b") +
					",SHA-512=" +
					btoa("cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce4" +
		...
		strictEqual(visit.hash.sum, "2413fb3709b05939f04cf2e92f7d0897fc2596f9ad0b8a9ea855c7bfebaae892",
								"high priority hash value");
		...
		var chan = createTestHttpChannel({
			...
			response: {
				...
				"Digest": "SHA-1=" + btoa("01586bsdf2c0ec5d8e985138204404878f5ecbeef58") +
					...
					",SHA-384=" + btoa("38b060a96384cd9327eb1b1e36a21fdb71114be07434c0cc7" +
														 "bf63f6e1da274edebfe76f65fbd51ad2f14898b95b") +
					",SHA-512=" + btoa("715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877e" +
...
(function() {
	...
	test("http duplicate links visit", function() {
		...
		visit.mirrors.sort(function(a, b) {
			...
			strictEqual(mirror.url.spec, "http://example.com/mirror" + expCount++,
									"duplicate link parsed with correct preference");
		});
	});
	...
	test("http describeby metalink visit", function() {
		...
		const visit = (new VisitorManager()).visit(chan);
		strictEqual(visit.metaDescribedBy.spec, "http://example.com/meta4",
								"described by metalink link parsed correctly");
	});
